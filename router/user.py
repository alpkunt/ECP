...
# # dikkat bu tekil update çalıştıramıyor, sen bunu çözdün daha önceki schema optional aynısından yapacaksın!
# @router.put('{id}/update')
# def update_user_all_fields(id: int, request: UserBase, db: Session = Depends(get_db)) -> object:
#     return db_user.update_user_all_fields(id, db, request)
